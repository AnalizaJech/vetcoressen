...
// Find the split point after </x-vc-table-layout>\n    @endif
$splitMarker = "</x-vc-table-layout>\n    @endif";
$pos = strpos($content, $splitMarker);
if ($pos === false) {
    // try with \r\n
    $splitMarker = "</x-vc-table-layout>\r\n    @endif";
    $pos = strpos($content, $splitMarker);
...
if ($pos === false) {
    die("Split marker not found\n");
}

$topPart = substr($content, 0, $pos + strlen($splitMarker));
...
echo "Successfully rebuilt cita-index.blade.php\n";
